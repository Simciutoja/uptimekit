...
function useStructureEditorState(statusPageId: string) {
    ...
    const handleDragOver = (event: DragOverEvent) => {
        ...
        setGroups((prev) => {
            ...
            next[activeGroupIdx] = {
                ...sourceGroup,
                monitors: newSourceMonitors,
            };
            next[overGroupIdx] = {
                ...targetGroup,
                monitors: newTargetMonitors,
            };
    ...
    const addGroup = () => {
        const collapsible =
            statusPageDesign.defaultSectionCollapsible !== false;
        setGroups([
            ...groups,
            {
                id: `temp-${generateId()}`,
                ...
                <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
                    <div>
                        ...
                        <p className="mt-2 text-muted-foreground text-sm">
                            Pick the monitors and heartbeats you want to display
                            on your status page.
                        </p>
                        <p className="mt-2 text-muted-foreground text-sm">
                            You can re-order the monitors by dragging the cards,
                            as well as give each monitor a public name.
                        </p>
                    </div>
                    ...
                    <div className="space-y-1.5">
                        ...
                        {onAddMonitor && (
                            <AddMonitorInput
                                ...
                                existingMonitorIds={group.monitors.map(
                                    (m: any) => m.id,
                                )}
                            />
                        )}
                        ...
                        {group.monitors.map((monitor: any) => (
                            <SortableMonitor
                                ...
                                onConfigChange={(updates) =>
                                    onConfigChange(monitor, updates)
                                }
                            />
                        ))}
                    </SortableContext>
            ...
            <DialogContent className="sm:max-w-lg">
                ...
                <DialogPanel className="space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        />
                        <p className="text-muted-foreground text-xs">
                            If provided, an info icon will appear next to the
                            monitor name.
                        </p>
                    </div>
                </DialogPanel>
